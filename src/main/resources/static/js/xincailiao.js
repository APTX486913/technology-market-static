        ...
        success: function (data) {
            if (data['status'] === 100) {
                ...
                $.each(data['value'], function (index, item) {
                    ...
                    dd.className = 'fs-14';
                    dd.innerHTML = '<a onclick="showpage(\'' + item['name'] + '\');"> ' + item['name'] + '</a>';
                ...
                showchengguoxinxi(1, cgpagesize, data['value'][0]['name']);
