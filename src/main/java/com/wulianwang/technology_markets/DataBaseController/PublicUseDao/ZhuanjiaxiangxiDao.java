...
@Mapper
public interface ZhuanjiaxiangxiDao {
    @Select("Call getProfessor_informationById(#{identity})")
    @Results({
    ...
    List<Zhuanjiaxiangxi> getZhuanjiaxiangxi(@Param("identity") String identity);
}
