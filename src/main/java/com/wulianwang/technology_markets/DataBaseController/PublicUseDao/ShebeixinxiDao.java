...
@Mapper
public interface ShebeixinxiDao {
    @Select("Call getExperimrntal(#{identity},#{start_subscript},#{pagesize})")
    @Results({
    ...
    List<Shebeixinxi> getShebeixinxi(@Param("identity") int identity, @Param("start_subscript") int start_subscript, @Param("pagesize") int pagesize);
}
