...
@Mapper
public interface InnovateplatDao {
    @Select("Call getInnovation_platorm(#{identity},#{start_subscript},#{pagesize})")
    @Results({
    ...
    List<Innovateplat> getInnovateplat(@Param("identity") int identity, @Param("start_subscript") int start_subscript, @Param("pagesize") int pagesize);
}
