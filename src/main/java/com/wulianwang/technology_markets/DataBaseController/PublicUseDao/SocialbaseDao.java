...
@Mapper
public interface SocialbaseDao {
    @Select("Call getSocial_base(#{identity},#{start_subscript},#{pagesize})")
    @Results({
    ...
    List<Socialbase> getSocialbase(@Param("identity") int identity, @Param("start_subscript") int start_subscript, @Param("pagesize") int pagesize);
