...
@Mapper
public interface XiangmuxinxiDao {
    @Select("Call getHorizontal(#{identity},#{start_subscript},#{pagesize})")
    @Results({
    ...
    List<Xiangmuxinxi> getXiangmuxinxi(@Param("identity") int identity, @Param("start_subscript") int start_subscript, @Param("pagesize") int pagesize);
}
