...
@Mapper
public interface SocialresultDao {
    @Select("Call getSocial_result(#{identity},#{start_subscript},#{pagesize})")
    @Results({
    ...
    List<Socialresult> getsocialresult(@Param("identity") int identity, @Param("start_subscript") int start_subscript, @Param("pagesize") int pagesize);
