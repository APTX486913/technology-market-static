...
@Mapper
public interface FiltrateInnovateplatDao {

    @Select("Call filtrategetPlatorm(#{industry_type},#{platform_type},#{organization})")
    @Results({
    ...
    List<Innovateplat> filtrateInnovateplat(@Param("industry_type") String industry_type, @Param("platform_type") String platform_type, @Param("organization") int organization);
}
