...
@Mapper
public interface FiltratezhuanliDao {
    @Select("Call filtrategetPatent(#{patent_type},#{organization})")
    @Results({
    ...
    List<Filtratezhuanli> filzhuanli(@Param("patent_type") String patent_type, @Param("organization") String organization);
}
