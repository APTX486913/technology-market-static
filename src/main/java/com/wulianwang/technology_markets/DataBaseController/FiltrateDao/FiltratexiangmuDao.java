...
@Mapper
public interface FiltratexiangmuDao {
    @Select("Call filtrategetHorizontal(#{project_source},#{project_level},#{affiliated_unit})")
    @Results({
    ...
    List<Xiangmuxinxi> filtratexiangmu(@Param("project_source") String project_source, @Param("project_level") String project_level, @Param("affiliated_unit") String affiliated_unit);
}
