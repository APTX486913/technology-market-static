...
@Mapper
public interface FiltratezhuanjiaDao {
    @Select("Call filtrategetProfessor(#{industry_type},#{sex},#{organization},#{tit})")
    @Results({
    ...
    List<Zhuanjiaxinxi> filtratezhuanjia(@Param("industry_type") String industry_type, @Param("sex") String sex, @Param("organization") String organization, @Param("tit") String tit);
}
